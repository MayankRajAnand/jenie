            ...
            <div className="px-4 lg:px-8">
                                ...
                                <FormItem className="col-span-12 lg:col-span-6">
                                    <FormControl className="m-0 p-0">
                                        <Input className="border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent"
                                            disabled={isLoading} placeholder="A picture of horse in Swiss alps" {...field}
                                        />
                                    </FormControl>
                                </FormItem>
                            ...
                            <FormField control={form.control} name="resolution" render={({ field }) => (
                                <FormItem className="col-span-12 lg:col-span-2">
                                    ...
                                    >
                                        <FormControl>
                                            <SelectTrigger>
                                                <SelectValue placeholder="Select amount" defaultValue={field.value} />
                                            </SelectTrigger>
                                        </FormControl>
                                        <SelectContent>
                ...
                <div className="space-y-4 mt-4">
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mt-8'>
                        {images.map((el)=>(
                            <Card key={el} className='rounded-lg overflow-hidden'>
                                <div className='relative aspect-square'>
                                    <Image alt="Image" fill src={el}/>
                                </div>
                                <CardFooter className='p-2'>
                                    <Button variant='secondary' className='w-full' onClick={()=>window.open(el)}>
